...
namespace Flux
{
    [CreateAssetMenu(fileName = "NewCSVRecipient", menuName = "Flux/CSV Recipient")]
    public class CSVRecipient : ScriptableObject
    {
        ...
        protected virtual void OnSheetsActualization() { }
        ...
        public IEnumerator Download() => Download(sheets => { });
