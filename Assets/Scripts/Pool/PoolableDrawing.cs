...
namespace BeauTambour
{
    public class PoolableDrawing : Poolable<LineRenderer>
    {
        ...
        public void AssignShape(Shape shape, int subDivision)
        {
            ...
            Event.CallLocal(EventType.OnDraw, gameObject, Value.GetPosition(0));
            ...
            Event.CallLocal(EventType.OnColorAssigned, gameObject, emotionColorRegistry[shape.Emotion]);
            Event.CallLocal(EventType.OnShapeRecognized, gameObject, Value.GetPosition(0));
        }
        ...
        public void Draw(float smoothing, float newTime)
        {
            ...
            Event.CallLocal(EventType.OnDraw, gameObject, Value.GetPosition(Value.positionCount - 1));
        }
        ...
        public void Complete(bool success)
        {
            ...
            Event.CallLocal(EventType.OnCompletion, gameObject, Value.GetPosition(Value.positionCount - 1));
