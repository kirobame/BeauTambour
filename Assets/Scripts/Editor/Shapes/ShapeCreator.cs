...
namespace BeauTambour
{
    public class ShapeCreator : EditorWindow
    {
        ...
        [MenuItem("Tools/Beau Tambour/Shape Creator")]
        ...
        private void DrawErrorRadius(Vector2 point, int index)
        {
            ...
            var errorRadius = shape.Points[index].toleranceRadius * radius;
        ...
        private void ProcessMouse(UnityEngine.Event Ev)
        {
        ...
        private void AddSection(UnityEngine.Event Ev)
        {
        ...
        private void InsertSection(UnityEngine.Event Ev)
        {
