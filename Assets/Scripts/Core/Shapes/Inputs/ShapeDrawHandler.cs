...
{
    [CreateAssetMenu(fileName = "NewShapeActivator", menuName = "Beau Tambour/Activators/Shape Draw")]
    public class ShapeDrawHandler : InputHandler<Vector2>, IContinuousHandler
    {
        ...
        void IContinuousHandler.Update()
        {
            if (isActive)
            {
                ...
                Prolong(new ShapeAnalysisResultsEventArgs(results));
            }
